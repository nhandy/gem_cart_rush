...
export default class PlayState extends Phaser.State {
    ...
    update () {
        ...
        if (this.cart.body.velocity.x < 200) {
            this.cart.body.velocity.x += 30;
            tracks.setAll('body.velocity.x', -(this.cart.body.velocity.x), 'true', 'false', 0);
        }
